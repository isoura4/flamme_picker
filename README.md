...
| `APP_MODE`       | `normal`                 | `normal` or `apres_soiree` (non-admin users can only access Memories) |
...
# After-party mode – public access limited to Memories
APP_MODE=apres_soiree npm start
